...
def welcome():
   ...
   <a href="/api/v1.0/stations">/api/v1.0/stations</a>
    ...
    <br>
    <a href="/api/v1.0/2018-01-01">/api/v1.0/2018-01-01</a>
    </li>
    <br>
    <li>
    ...
    <br>
    <br>
    <a href="/api/v1.0/2018-01-01/2018-01-07">/api/v1.0/2018-01-01/2018-01-07</a>
    </li>
    <br>
    </ul>
    </html>
...
def precipitation():
    ...
    year_ago = dt.datetime.strptime(max_date, "%Y-%m-%d") - dt.timedelta(days=36)
...
def tobs(): 
    ...
    # Calculate the date 1 year ago from today
    # The days are equal 36 so that the first day of the year is included
